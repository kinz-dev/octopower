...
use eyre::Report;
use octopower::{authenticate, get_account, get_consumption, AuthToken, MeterType, get_standard_unit_rates, Grouping};
...
async fn show_unit_rate(token: &AuthToken, meter_type: MeterType, product_code: &str, tariff_code: &str) {
